...
import { createBudget, fetchData, createExpense,deleteItem } from "../helpers";
...
const Dashboard = () => {
  ...
  // Sort expenses by createdAt date
  const sortedExpenses = expenses?.sort((a, b) => b.createdAt - a.createdAt).slice(0,5);
              ...
              <div className="grid-lg">
                ...
                {expenses && expenses.length > 0 && (
                  <div className="grid-md">
                    ...
                    {expenses.length>5 && (<Link to="expenses" className="btn btn--dark">View All expenses</Link>)}
                  </div>
                )}
              </div>
            ) : (
